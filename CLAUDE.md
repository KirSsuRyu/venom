...
| `60-project.md` | 프로젝트 특화 규칙 (스택, 명령, 디렉토리) |
| `61-architecture.md` | 아키텍처 레이어·모듈 경계·의존 방향 |
| `62-domain.md` | 도메인 용어·불변 규칙·엔티티 관계 |
| `63-patterns.md` | 개발 패턴 카탈로그·에러 처리·비동기 규칙 |
| `70-…` | 추가 부록 (있으면 상위를 덮어씀) |
