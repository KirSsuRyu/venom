---
name: compact-guide
description: 컨텍스트 압축(compaction) 타이밍을 안내합니다. "컴팩트해줘", "컨텍스트 정리해줘", "compact-guide", "context가 꽉 찼어", "토큰이 부족해" 등에 트리거합니다. 언제 압축해야 하고 언제 하면 안 되는지 판단 기준과 압축 전 체크리스트를 제공합니다.
---
